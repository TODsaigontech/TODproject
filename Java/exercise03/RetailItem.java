...
/**
 * The RetailItem class stores data about a retail item for the RetailItem Class
...
public class RetailItem {
	...
	public RetailItem(String d, int u, double p)throws InvalidPrice, InvalidUnits{
		description = d;
		if(u<0) {
	...
	public void setUnitsOnHand(int u) throws InvalidUnits {
		if(u<0) {
			throw new InvalidUnits(u);
		}else {
			unitsOnHand=u;
